...
import feedbackservicepublisher.FeedbackServicePublish;
...
public class ServiceActivator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
		System.out.println("Start Feedback Subscriber.!");
		FeedbackServiceRef = context.getServiceReference(FeedbackServicePublish.class.getName());
		FeedbackServicePublish FeedbackServicePublish = (FeedbackServicePublish)context.getService(FeedbackServiceRef);
		...
		while (opt == 1) {
			...
			if (opt2 == 4) {
				System.out.println("");
				FeedbackServicePublish.publishService();
				System.out.println("");
	...
	public void stop(BundleContext context) throws Exception {
		System.out.println("Stop Feedback Service Subscriber.!!!!...");
